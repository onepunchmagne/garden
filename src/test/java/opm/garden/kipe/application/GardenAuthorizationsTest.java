...
import static opm.garden.kipe.domain.RolesAccessesFixture.*;
...
import opm.garden.kipe.domain.RolesAccessesFixture.TestResource;
...
@UnitTest
class GardenAuthorizationsTest {

  private static final GardenAuthorizations authorizations = new GardenAuthorizations(List.of(rolesAccesses()));
